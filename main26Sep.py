...
def ch11():
	...
	#put in our session_state.prompt_template 
...
def ch15_chatbot():
	...
	st.write(memory_data)
	st.session_state.prompt_template = f"""{input_prompt}
										This is the conversation history between the AI and human	
										{memory_data}
										"""
	 #call the function in your base bot
	#Initialize chat history
...
#Challenge 3
	with st.sidebar:
		option = st.selectbox("Function exercises", ["ex1", "ex2", "ch2", "ex3", "ch3", "ex4a", "ex4b", "ch4", "ex5", "ex6", "ch6", "ex8", "ch8", "ex9", "ex10", "ch10", "ex11a", "ex11b", "ch11", "ex12", "ch12", "ex13", "ex14", "ex15", "ch15", "ex16", "ex17", "ex18"])
	if option == "ex1":
		ex1()
	elif option == "ex2":
		ex2()
